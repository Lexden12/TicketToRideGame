...
public class CityGraph {
    ...
    public CityGraph() {
        ...
        routes.put("Duluth1", new Route(duluth, 2, "Grey"));
        routes.put("Duluth2", new Route(duluth, 2, "Grey"));
        ...
        routes.put("Omaha1", new Route(omaha, 2, "Grey"));
        routes.put("Omaha2", new Route(omaha, 2, "Grey"));
